...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen w-full bg-[--page] flex flex-col relative overflow-hidden">
      ...
      {/* Navbar */}
      <nav className="w-full flex items-center justify-between px-8 py-5 bg-(--brand) shadow-md z-10" style={{ boxShadow: '0 2px 12px rgba(10,152,146,0.08)' }}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center z-10">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-(--brand) text-white text-base rounded-full shadow font-semibold min-w-42.5 border-2 border-[--line] hover:border-[--brand] transition-colors duration-300 cursor-pointer hover:bg-black hover:bg-opacity-80"
